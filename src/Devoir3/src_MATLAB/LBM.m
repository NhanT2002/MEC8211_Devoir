...
function [poro_eff, Re, k_in_micron2]=LBM(filename,NX,deltaP,dx,d_equivalent,seed)
close all;
NY=NX; % square domain
...
filename_output = strcat('velocity_dx_', num2str(dx), '_seed_', num2str(seed), '.png')
saveas(gcf, filename_output)